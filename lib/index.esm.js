import { defineComponent as defineComponent$1, openBlock, createElementBlock, createElementVNode, normalizeClass as normalizeClass$1 } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", null, [
    createElementVNode("i", {
      class: normalizeClass$1(`z-icon-${_ctx.name}`)
    }, null, 2 /* CLASS */)
  ]))
}
